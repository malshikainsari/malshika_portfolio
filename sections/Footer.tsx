        ...
        <div className="flex flex-col items-start justify-between gap-10 lg:flex-row lg:items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="group relative flex h-11 w-11 items-center justify-center rounded-full border border-white/10 bg-white/[0.03] text-[#FFFBF4]/75 transition duration-300 hover:border-[#565449]/50 hover:bg-[#565449]/10 hover:text-[#FFFBF4] hover:shadow-[0_0_24px_rgba(86,84,73,0.18)]"
            >
              <span className="absolute inset-0 rounded-full bg-[#565449] opacity-0 blur-md transition duration-300 group-hover:opacity-35" />
              <Mail className="relative transition duration-300 group-hover:-translate-y-0.5 group-hover:scale-110" size={20} />
            </a>
          </div>
        </div>
